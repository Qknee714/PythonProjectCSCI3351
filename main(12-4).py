...
def game_loop():
    ...
    while not done:
        ...
        text_fact1 = font.render("Cardboard boxes can be recycled at least seven times", True, "White")
        text_fact2 = font.render("Every year, 2.4 million tons of recycled glass are used to make new bottles and jars",
                                 True,
                                 "White")
        text_fact3 = font.render("More than 52 million tons of paper \nproducts were recycled in 2018. \nThat’s "
                                 "roughly "
                                 "the same weight as almost\n 350,000 blue whales", True, "White")

        text_fact4 = font.render(
            "If you recycle one glass bottle, it saves enough energy to light a 100-watt bulb for four "
            "hours",
            True, "White")
        text_fact5 = font.render(
            "In the U.S., enough stainless steel is recycled each year to build nearly 1,500 Gateway "
            "Arches.",
            True, "White")
        text_fact6 = font.render(
            "One metric ton of electronic scrap from personal computers contains more gold than that "
            "recovered from 17 tons of gold ore.",
            True, "White")

        '''font.render("The average paper usage per person is around 700 pounds per year.", True, (0, 0, 0)),
                     font.render("A massive 80 billion soda cans are consumed in the US each year.", True, (0, 0, 0)),
                     font.render("The glass recycling rate in the US is around 33%..", True, (0, 0, 0)),
                     font.render(
                         "Around 10 million tons of glass that is disposed of by Americans gets recycled each year.",
                         True, (0, 0, 0)),
                     font.render("Discarded electronics in landfills make up 2% of the total trash found there.", True,
                                 (0, 0, 0)),
                     font.render(
                         "One study suggests that plastic pollution affects at least 700 marine species, "
                         "but in reality, this figure is likely to be much higher.",
                         True, (0, 0, 0)),
                     ]'''

        # randomly select the fact to display
        display_fact = random.choice([text_fact1, text_fact2, text_fact3, text_fact4, text_fact5, text_fact6])
        ...
        if game.state == "gameover":
            ...
            screen.blit(display_fact, [550, 200])
